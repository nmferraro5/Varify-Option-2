    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="index_Varify.html">Varify</a>
      ...
      <div class="row-fluid">
        <div class="span9">
          <div class="hero-unit" style="margin-right:-220px;">
            <h2>Varify Contact Information</h2>
            <br>
            <p>Please contact NAME at <b style="color: #3a9aad;">email@chop.edu
            </b> from the Center for Biomedical Informatics at the Children's Hospital of Philadelphia, 
           	with any questions, concerns, or inquiries.</p>
